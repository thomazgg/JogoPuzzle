...
#pragma warning restore 649
    ...
    {
        // Loop through all the available categories in our QuizManager
        for (int i = 0; i < quizManager.QuizData.Count; i++)
        {
            ...
            // Set the button values including the category image
            categoryBtn.SetButton(quizManager.QuizData[i].categoryName, quizManager.QuizData[i].categoryImage, quizManager.QuizData[i].questions.Count);

            int index = i;
            // Add listener to the button which calls CategoryBtn method
